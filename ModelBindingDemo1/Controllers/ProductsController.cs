...
using ModelBindingDemo1.Model;

namespace ModelBindingDemo1.Controllers
{
    ...
    public class ProductsController : ControllerBase
    {
        ...
        /*
        //gives me product wise data list
        [HttpGet("{Category:string}")]
        public async Task<IActionResult> GetProductByCat([FromQuery] string Category)
        {
