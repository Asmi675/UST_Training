    ...
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            builder.Services.Configure<RequestLocalizationOptions>(options =>
            {
                ...
                options.SupportedCultures = supportedCultures.Select(culture => new System.Globalization.CultureInfo
                (culture)).ToList();
                options.SupportedUICultures = supportedCultures.Select(culture => new System.Globalization.CultureInfo
                (culture)).ToList();
